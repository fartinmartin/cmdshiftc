...
1. This is a 2nd set of steps
   - Rename the other duplicate comp to `3D Layers` and double click to open it up.
   - Count to ten.
   - Eat the ||S|| key.
   - Check on the <Prop variant="ae">Scale</Prop> property.
2. Temp 2nd step

Paragraph separation.

1. First, let’s duplicate our `Master` comp.
   - Rename the duplicate comp.
2. Temp 2nd step
