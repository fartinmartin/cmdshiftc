...
Well, we could imagine that each one of these
...
character—we are just seeing 1/3rd masked out and placed in either the top, center, or bottom section.
...
lorem , right? But we could get more precise, right? And we could do this s“non-destructively” so that we could swap in any video, animation, or image in any of the sides? Yeah, a little rig, that would be neat...
