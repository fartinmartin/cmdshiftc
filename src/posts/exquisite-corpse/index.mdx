...
<ProjectFile><a href="#here-we-go">Skip</a> to the introduction steps!</ProjectFile>
...
<ProjectFile><a href="#building-our-faux-3d-box">Skip</a> to the beginner steps!</ProjectFile>
...
<ProjectFile><a href="#non-uniformly-scaling-our-2d-layers">Skip</a> to the intermediate steps!</ProjectFile>
...
<ProjectFile><a href="#building-our-faux-3d-box">Skip</a> to the advanced steps!</ProjectFile>
